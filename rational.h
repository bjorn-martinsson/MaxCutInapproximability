...
struct Rational {
  ...
  Rational<T> inverse() const { return Rational<T>(b, a); }
  ...
  Rational<T> operator-() const { return Rational<T>(-a, b); }

  Rational<T> operator+(T other) const { return Rational<T>(a + other * b, b); }

  Rational<T> operator-(T other) const { return Rational<T>(a - other * b, b); }

  Rational<T> operator*(T other) const { return Rational<T>(a * other, b); }

  Rational<T> operator/(T other) const { return Rational<T>(a, b * other); }
  ...
  bool operator<(const T& other) const { return a < b * other; }
